function changeGroup23(currentOption){
    ...
    if(currentOption==2){
        ...
        var valueSelectdOn1 = "group3_"+document.getElementById("customOptions_group1").value;
...
function checkToSubmit(){
    if (document.getElementById("customOptions_group1").value == 0){
		if(document.getElementById("customOptions_group1").value == 0 && document.getElementById("customOptions_group2").value == 0 && document.getElementById("customOptions_group3").value == 0){
...
function submitWorkcomplete(skipDateValidation){
    ...
    }else if ( document.getElementById("customOptions_group2").value == 0 && document.getElementById("customOptions_group3").value != 0 ){
